    ...
    public class Reserva
    {
        ...
        public void CadastrarHospedes(List<Pessoa> hospedes)
        {
            ...
            else
            {
                ...
                throw new ArgumentException($"Quantidade de hospedes excedeu o limite de {Suite.Capacidade} hospedes.");
            }
        }
        ...
        public string CalcularValorDiaria()
        {
            ...
            return DateFormating(valor);
        }

        private string DateFormating(decimal value)
        {
